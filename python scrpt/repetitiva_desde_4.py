...
script en Python que muestra la tabla de multiplicar de un
numero ingresado por el usuario. El usuario tambien podra ingresar
hasta que valor llegara la tabla de multiplicar
'''
